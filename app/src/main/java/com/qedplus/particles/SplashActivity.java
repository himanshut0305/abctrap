...
import com.qedplus.particles.services.SchoolServices;
import com.qedplus.particles.services.StudentServices;
...
public class SplashActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onSchoolLogoClick(View v) {
        StudentServices studentServices = new StudentServices(getApplicationContext(), new StudentServices.UITask() {
            @Override
        ...
        studentServices.getStudentDetails(context);
    }
