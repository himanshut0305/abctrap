                ...
                if(school != null) {
                    ...
                    try {
                        ...
                        if(responseCode == 200) {
                            ...
                            EducationBoard educationBoard = educationBoardDao.findByName(schoolResponse.getBoard().getName());
                            int educationBoardId = 0;

                            if (educationBoard == null) {
                                educationBoard = new EducationBoard(schoolResponse.getBoard().getName(), schoolResponse.getBoard().getAka());
                                long[] educationBoardIds = educationBoardDao.insertAll(educationBoard);
                                educationBoardId = (int) educationBoardIds[0];
                            }
                            else {
                            ...
                            School newSchool = new School(schoolResponse.getName(), schoolResponse.getSchoolCode(), educationBoardId, logo.getAbsolutePath(), schoolResponse.getSchoolTheme());
